...
;---------------------------------------------------------------------------
;Energy Barrage
[State -1, Energy Barrage]
type = ChangeState
value = 1900
triggerall = (command = "KiBarrage1" || command = "KiBarrage2" || command = "KiBarrage3") && command != "holddown" && power >= 1000
trigger1 = statetype = S && ctrl
trigger2 = stateno = 3100
;---------------------------------------------------------------------------
;Chain Mouth Beam
...
type = ChangeState
value = 1010
triggerall = (command = "QCF_x" || command = "QCF_y" || command = "QCF_z") && command != "holddown"; && statetype = S && ctrl
trigger1 = (stateno = 810) && time > 18
...
type = ChangeState
value = 2700
triggerall = (var(34) != 1 && var(34) != 12)
triggerall = ((command = "a" && command = "b") || (command = "b" && command = "c") || (command = "a" && command = "c")) && command = "holdback"
trigger1 = (stateno = 270 || (stateno = [1400,1430])) && movehit && time = [3,28]
trigger2 = (stateno = 1552 || stateno = 1557 || stateno = 1559) && movehit && time = [3,28]
trigger3 = (stateno = 2711) && movehit && time = [2,22]

; TeleKickUp Chain
[State -1, TKU.Chain]
type = ChangeState
value = 2710
triggerall = (var(34) != 2 && var(34) != 12)
triggerall = ((command = "a" && command = "b") || (command = "b" && command = "c") || (command = "a" && command = "c")) && command = "holdup"
trigger1 = (stateno = 270 || (stateno = [1400,1430])) && movehit && time = [3,28]
trigger2 = (stateno = 1552 || stateno = 1557 || stateno = 1559) && movehit && time = [3,28]
trigger3 = (stateno = 2701) && movehit && time = [2,22]
;===========================================================================
;-=Basic Attacks=-
;---------------------------------------------------------------------------
; Launcher
