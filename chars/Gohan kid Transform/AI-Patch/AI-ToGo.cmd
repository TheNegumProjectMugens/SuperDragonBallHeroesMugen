...
; AI combo3
[State -1, AI Combo 3 Swop Kick Down]
type = ChangeState
triggerall = Var(55) = 1
triggerall = random >= 250 && random < 299 || random >= 550 && random <= 999
triggerall = p2life > 0
...
; AI combo3
[State -1, AI Combo 3 Swop Kick Up]
type = ChangeState
triggerall = Var(55) = 1
triggerall = random >= 250 && random < 299 || random >= 550 && random <= 999
triggerall = p2life > 0
...
[State -1, AI Transform Normal To SSJ1]
type = ChangeState
value = 100000
triggerall = var(15) = 0
TRIGGERALL = POWER >= 1000
...
[State -1, AI Transform SSj1 To SSj2]
type = ChangeState
value = 200000
triggerall = var(15) = 1
TRIGGERALL = POWER >= 1000
...
[State -1, AI Transform SSj2 To SSj3]
type = ChangeState
value = 300000
triggerall = var(15) = 2
TRIGGERALL = POWER >= 1000
...
; AI Crouch Uppercut Kick
[State -1, AI Crouch Uppercut Kick]
type = ChangeState
value = 400
triggerall = Var(55) = 1
triggerall = random >= 250 && random < 299 || random >= 550 && random <= 999
...
[State -1, AI Transform SSj1 To Normal]
type = ChangeState
value = 100001
triggerall = var(15)= 1
...
[State -1, AI Transform SSj2 To SSj1]
type = ChangeState
value = 200001
triggerall = var(15) = 2
TRIGGERALL = POWER >= 1500
...
[State -1, AI Transform SSJ3 To SSJ2]
type = ChangeState
value = 300001
triggerall = var(15) = 3
TRIGGERALL = POWER >= 1500
...
[State -1, AI Transform SSJ3 To Normal]
type = ChangeState
value = 300002
triggerall = var(15) = 3
TRIGGERALL = POWER >= 1500
