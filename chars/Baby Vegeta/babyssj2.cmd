;===================baby vegeta ssj 2 by frs games===================================

; EU COLOQUEI UM SUPER COMBO PARA O BABY VEGETA SSJ 2 manual que e E BEM SIMPLES DE SE FAZER
;x,a,a,x,x,a,a,y,y,b,b e finalizado com o super garlik hou
[Command]
name = "IA1"
command = D, DF, F, b,a
time = 1
...
time = 30
[Command]
name =  "baby combo divertido"
command = D, DB, B, F ,x   ;x,x,x,x,x,x,x,x no final complete com  D, DB, B, F ,x
time = 30
[Command]
name =  "mini bola de rancor"
command = D, DB, B, F ,x  ; complemento do baby combo divertido
time = 30
[Command]
name =  "raio mortal"
command = D, DB, B, F ,b
...
[Command]
name = "atak com vento"
command = D, DF, F, z     ;aperte varias vezes o z,z,z,z,z,z,z
time = 15
[Command]
name = "explosao que sai do chao"
command = D, DB, B, y
time = 15
[Command]
...
[Command]
name = "baby Combo xxx"
command = D, DF, F, x  ;complete com  D, DF, F, x ,D, DF, F, x,D, DF, F, x
time = 15
[Command]
name = "baby Combo a"
command = D, DB, B, a
...
command = D, DF, F, b     ;aperte varias vezes o b,b,b,b,b,b
time = 15
[Command]
name = "chutes"
command = D, DF, F, a     ;aperte varias vezes o  a,a,a,a,a
time = 15
[Command]
name = "baby Combo y"
command = D, DF, F, y  ;complete com ,y,y,y,y,y,y
time = 15
[Command]
...
type = ChangeState
value = 4700
triggerall = command = "baby combo divertido"
...
type = ChangeState
value = 4900
triggerall = command = "raio mortal"
...
type = ChangeState
value = 4001
triggerall = command = "Super energia" && Power >= 2000
...
type = ChangeState
value = 4800
triggerall = command = "big bang atack"
...
type = ChangeState
value = 2004
triggerall = command = "3 bolas" && Power >= 500
trigger1 = (statetype = S || statetype = A) && ctrl
trigger2 = Stateno = 107
trigger3 = stateno = [200,400]
trigger3 = (movecontact)
...
type = ChangeState
value = 2002
triggerall = command = "explosao que sai do chao" && Power >= 500
trigger1 = (statetype = S || statetype = A) && ctrl
trigger2 = Stateno = 107
trigger3 = stateno = [200,400]
trigger3 = (movecontact)
...
type = ChangeState
value = 3000
triggerall = command = "baby Combo x"
...
type = ChangeState
value = 2005
triggerall = command = "baby Combo xxx"
trigger1 = (statetype = S || statetype = A) && ctrl
trigger2 = Stateno = 107
trigger3 = stateno = [200,400]
trigger3 = (movecontact)
...
type = ChangeState
value = 3999
triggerall = command = "baby Combo a"
trigger1 = (statetype = S || statetype = A) && ctrl
trigger2 = Stateno = 107
trigger3 = stateno = [200,400]
trigger3 = (movecontact)
...
type = ChangeState
value = 3001
triggerall = command = "baby Combo y"
trigger1 = statetype = S  && ctrl
trigger2 = stateno = [200,400]
trigger2 = (movecontact)
[State -1]
...
type = ChangeState
value = 1000
triggerall = command = "z" && movetype != H
